...
static inline zhash_t *
zset_create (size_t keysz,
...
static inline void
zset_vmap (zset_t *zs, void (*f)())
{
    zhash_vmap_keys (zs, f);
}

static inline void
zset_map (zset_t *zs, void (*f)())
{
    zhash_map_keys (zs, f);
}

static inline void
zset_destroy (zset_t *zs)
{
    zhash_destroy (zs);
}

static inline int
zset_add (zset_t *zs, const void *key, void *oldkey)
{
...
static inline int
zset_remove (zset_t *zs, const void *key, void *oldkey)
{
    return zhash_remove (zs, key, oldkey, NULL);
}

static inline int
zset_contains (zset_t *zs, const void *key)
{
...
static inline void
zset_iterator_init (zset_t *zs, zset_iterator_t *zit)
{
    zhash_iterator_init (zs, zit);
}

static inline int
zset_iterator_next (zset_iterator_t *zit, void *outkey)
{
 ...
 */
static inline int
zset_equals (zset_t *a, zset_t *b, void *scratch_ptr)
{
    zset_iterator_t it;
