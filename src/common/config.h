 ...
 */
int config_has_key (config_t *conf, const char *key);
...
char *config_get_str_or_fail (config_t *conf, const char *key);
 ...
 */
int config_get_array_len (config_t *conf, const char *key);
